...
- [x] JS/CSS 번들 용량 예산 수치화(`P6-04`) 및 CI 경고 추가.
...
- [x] `P2-05` 그래프 전용 페이지 또는 동등한 전역 그래프 뷰 구조 패리티 확정 후 적용.
...
- [x] `P3-05` TOC 생성 및 우측 패널 표시: 헤딩 계층/현재 섹션 추적.
- [x] `P3-06` 링크 hover preview 구현: 내부 링크 카드 미리보기.
- [x] `P3-07` 로컬 그래프 데이터 생성: 현재 노트 주변 n-hop 관계.
- [x] `P3-08` 로컬 그래프 위젯 구현: 노트 페이지 우측 패널 연결.
- [x] `P3-09` 글로벌 그래프 상호작용 정교화: 포커스/필터/검색 연동.
- [x] `P3-10` 백링크 섹션 UX 개선: 정렬 기준/미리보기/빈 상태 처리.
...
- [x] `P6-04` 성능 예산 설정: LCP, JS 용량, CSS 용량.
- [x] `P6-05` HTML/링크 무결성 검사(깨진 내부 링크 탐지).
