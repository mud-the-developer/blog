  ...
  <section class="news-digest-top-shell" aria-label="Top signals">
    ...
    <div class="news-digest-top-grid">
      ...
      <a class="news-digest-card news-digest-top-card" href="https://news.hada.io/topic?id=27920" target="_blank" rel="noreferrer">
        <img class="news-digest-image" src="/news/assets/thumb-ai.svg" alt="Show GN: Geas - Claude Code Contract-based governance harness for multi-agent long-term operations" width="1200" height="675" loading="lazy" decoding="async" referrerpolicy="no-referrer" onerror="this.onerror=null;this.src='/news/assets/thumb-ai.svg';" />
        <div class="news-digest-card-copy">
