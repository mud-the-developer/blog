...
<div class="news-digest-shell">
    ...
    <div class="news-digest-grid">
      ...
      <a class="news-digest-card" href="https://github.com/LearningCircuit/local-deep-research" target="_blank" rel="noreferrer">
        ...
        <div class="news-digest-card-copy">
          <div class="news-digest-card-eyebrow">
            <span class="news-digest-card-badge news-digest-card-badge--repo">Repo</span>
            <span class="news-digest-card-meta">GitHub · 4196 stars · 4196/day · 0h ago · signal 9.26</span>
          </div>
          <h3>LearningCircuit/local-deep-research</h3>
          <p class="news-digest-card-deck">Local Deep Research achieves ~95% on SimpleQA benchmark (tested with GPT-4.1-mini). Supports local and cloud LLMs (Ollama, Google, Anthropic, ...). Searches 10+ sources - arXiv, PubMed, web…</p>
        </div>
      </a>
      <a class="news-digest-card" href="https://github.com/ggml-org/llama.cpp" target="_blank" rel="noreferrer">
        ...
        <div class="news-digest-card-copy">
          <div class="news-digest-card-eyebrow">
            <span class="news-digest-card-badge news-digest-card-badge--repo">Repo</span>
            <span class="news-digest-card-meta">GitHub · 100013 stars · 100013/day · 0h ago · signal 9.09</span>
          </div>
          <h3>ggml-org/llama.cpp</h3>
          <p class="news-digest-card-deck">LLM inference in C/C++. Surfaced 0h ago with 100013 stars and 100013/day momentum.</p>
        </div>
      </a>
      <a class="news-digest-card" href="https://github.com/HomericIntelligence/ProjectMnemosyne" target="_blank" rel="noreferrer">
        ...
        <div class="news-digest-card-copy">
          <div class="news-digest-card-eyebrow">
            <span class="news-digest-card-badge news-digest-card-badge--repo">Repo</span>
            <span class="news-digest-card-meta">GitHub · 11 stars · 11/day · 0h ago · signal 8.97</span>
          </div>
      ...
      <a class="news-digest-card" href="https://github.com/NVIDIA/TensorRT-LLM" target="_blank" rel="noreferrer">
        ...
        <div class="news-digest-card-copy">
          <div class="news-digest-card-eyebrow">
            <span class="news-digest-card-badge news-digest-card-badge--repo">Repo</span>
            <span class="news-digest-card-meta">GitHub · 13200 stars · 13200/day · 0h ago · signal 8.69</span>
          </div>
  ...
  <section id="digest-social" class="news-digest-section">
    ...
    <div class="news-digest-grid">
      <a class="news-digest-card" href="https://news.hada.io/topic?id=28014" target="_blank" rel="noreferrer">
        <img class="news-digest-image" src="/news/assets/thumb-ai.svg" alt="Miasma: A tool that traps AI web scrapers in an endless loop of contamination" width="1200" height="675" loading="lazy" decoding="async" referrerpolicy="no-referrer" onerror="this.onerror=null;this.src='/news/assets/thumb-ai.svg';" />
        <div class="news-digest-card-copy">
          <div class="news-digest-card-eyebrow">
            <span class="news-digest-card-badge news-digest-card-badge--social">Social</span>
