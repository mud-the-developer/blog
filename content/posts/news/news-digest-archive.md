...
<div class="news-digest-shell news-digest-archive-shell">
  <section class="news-digest-hero">
    <div class="news-digest-hero-copy">
      ...
      <div class="news-digest-actions" role="group" aria-label="Archive actions">
        <a class="post-cta-link" href="/notes/news/2026-04-11-ai-news-beta-digest/">Latest brief</a>
        <a class="post-cta-link" href="/notes/news/2026-04-11-ai-news-digest/">Structured digest</a>
  ...
  <section class="news-digest-archive news-digest-archive-months">
    <header class="news-digest-section-head">
      ...
      <p class="news-digest-section-description">GitHub velocity is led by BerriAI/litellm; paper attention is clustering around Act Wisely: Cultivating Meta-Cognitive Tool Use in Agentic Multimodal Models; social attention is tilting toward Show GN: Advisor Opus — Implementing Anthropic’s Advisor Strategy with Claude Code plugin; biggest mover: NVIDIA/NemoClaw (+2). 10 repo signals, 10 paper picks, and 10 community items made today&#x27;s cut.</p>
    </header>
    <div class="news-digest-month-groups">
      <details class="news-digest-month-group" open>
        <summary class="news-digest-month-summary"><span>April 2026</span><span class="news-digest-month-count">11 digests</span></summary>
